...
-- La colonne « niveau » est l'axe de regroupement du mur des contributions.
...
comment on column formation_restitution.niveau is
  'Niveau ou cycle de la classe — axe de regroupement des contributions.';
